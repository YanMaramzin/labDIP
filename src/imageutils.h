...
namespace ImageUtils
{
    ...
    Mat quantizedImage(Mat &image, int quantLevel);
    ...
    double sko(const Mat &image, Mat quantImage);
    ...
    std::vector<std::vector<double>> gaussMask(float sigma, int rows, int cols);
